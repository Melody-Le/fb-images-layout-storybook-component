...
export var ImageGridComponent = function (_a) {
    ...
    return (_jsx(_Fragment, { children: showCarousel ? (_jsx(CarouselContainer, __assign({ ref: newRef }, { children: _jsx(Carousel, { imgList: images, selectedImgIndex: selectedImgIndex }) }))) : (_jsxs(ImageGrid, __assign({ height: imagesGridHeight, maxWidth: imagesGridMaxWidth, numberOfImgs: numberOfImgs, row: rowCol.row, col: rowCol.col, "data-testid": "wrapper" }, { children: [numberOfImgs <= MAX_PREVIEW_NUM &&
                    images.slice(0, numberOfImgs).map(function (photo, index) { return (_jsx(ImageWrap, __assign({ onClick: function () { return openCarousel(index); } }, { children: _jsx(ImageItem, { id: "".concat(index), src: photo.url || "default.jpg", alt: (photo === null || photo === void 0 ? void 0 : photo.alt) || "photo" }) }), index)); }), numberOfImgs > MAX_PREVIEW_NUM &&
                    images
                        .slice(0, MAX_PREVIEW_NUM)
                        .map(function (photo, index) { return (_jsxs(ImageWrap, __assign({ style: { position: "relative" }, onClick: function () { return openCarousel(index); } }, { children: [_jsx(ImageItem, { id: "".concat(index), src: photo.url || "default.jpg", alt: (photo === null || photo === void 0 ? void 0 : photo.alt) || "photo" }), index === MAX_PREVIEW_NUM - 1 && (_jsxs(NumberOfRemainingImgs, { children: ["+ ", numberOfImgs - MAX_PREVIEW_NUM] }))] }), index)); })] }))) }));
};
...
var NumberOfRemainingImgs = styled.p(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  color: white;\n  font-size: 1.5rem;\n"], ["\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  color: white;\n  font-size: 1.5rem;\n"])));
